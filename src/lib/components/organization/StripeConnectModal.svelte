<script lang="ts">
	...
	import { Mail, AlertCircle, Loader2 } from 'lucide-svelte';
	...
	<DialogContent class="sm:max-w-md">
		...
		{#if error}
			<div
				...
				class="flex items-start gap-2 rounded-lg border border-destructive/50 bg-destructive/10 p-3 text-destructive"
				role="alert"
			>
