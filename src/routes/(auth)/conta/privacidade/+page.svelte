...
>
	<DialogContent class="sm:max-w-md">
		...
		<div class="space-y-2 rounded-md bg-destructive/5 p-4">
...
{#if fileToDelete}
	...
	>
		<DialogContent class="sm:max-w-md">
			...
			<div class="rounded-md border border-amber-500/30 bg-amber-50 p-4 dark:bg-amber-950/30">
